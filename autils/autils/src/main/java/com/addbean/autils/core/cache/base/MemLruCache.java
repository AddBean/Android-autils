...
package com.addbean.autils.core.cache.base;

import com.addbean.autils.core.cache.KeyExpiryMap;
import com.addbean.autils.utils.ALog;

import java.util.LinkedHashMap;
import java.util.Map;

public class MemLruCache<K, V> {
    ...
    public synchronized final String toString() {
        ...
        return String.format("MemLruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", maxSize, hitCount, missCount, hitPercent);
    }
}
