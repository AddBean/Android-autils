...
public class AnimUtils {
     ...
     * @return
     */
    public static Animation ScaleAnim(final View view, final AnimListener mAnimListener) {
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                if (mAnimListener != null) mAnimListener.onBegin(view);
            }

            @Override
            public void onAnimationEnd(Animation animation) {
                if (mAnimListener != null) mAnimListener.onOver(view);
            }
